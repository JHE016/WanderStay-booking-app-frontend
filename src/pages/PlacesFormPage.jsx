...
export default function PlacesFormPage() {
    ...
    async function savePlace(ev){
        ev.preventDefault();
        const placeData = {title, address, city, phone, addedPhotos, description, 
    ...
    return (
        <div>
            ...
            <form onSubmit={savePlace}>
                ...
                {preInput('Check in & out time, max guests', 'house rules and extra information', 'Add check in and out times, have time window for cleaning between guests')}
